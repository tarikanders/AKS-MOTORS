...
const faqs = [
  {
    ...
    a: "En moyenne 3 à 4 mois : 2 à 4 semaines pour trouver le bon lot aux enchères, 6 à 8 semaines de transport maritime, puis 4 à 6 semaines pour le dédouanement et l'homologation DREAL/UTAC. Nous vous donnons un calendrier précis dès le démarrage."
  },
  {
  ...
  },
  {
    ...
    a: "La feuille d'enchère japonaise (USS, CAA) est le document de référence : elle détaille précisément l'état de chaque partie du véhicule, avec note globale et photos. Nous vous la fournissons intégralement traduite. Sur demande, et uniquement pour la Corée, nous pouvons mandater un inspecteur local pour une vérification supplémentaire."
  },
  {
