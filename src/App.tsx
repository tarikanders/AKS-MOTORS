      ...
      <AnimatePresence>
        {showTop && (
          <motion.a
            ...
            className="fixed bottom-24 right-6 z-50 w-14 h-14 bg-green-600 hover:bg-green-500 text-white rounded-full flex items-center justify-center shadow-xl transition-colors"
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            exit={{ opacity: 0, scale: 0.8 }}
            onClick={scrollTop}
            className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-zinc-800 hover:bg-zinc-700 text-white rounded-full flex items-center justify-center border border-white/10 shadow-xl transition-colors"
